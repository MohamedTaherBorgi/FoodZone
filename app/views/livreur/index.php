        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="datatable-wrapper table-responsive">
                                <table id="datatable" class="table table-borderless table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM `livraison`"; // Fetch all users
                                        ...
                                        if ($result->rowCount() > 0) {
                                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                if ($statut == 'EN_ATTENTE') {
                                                    $badgeClass = "badge badge-info-inverse";
                                                } elseif ($statut == 'ANNULEE') {
                                                    $badgeClass = "badge badge-danger-inverse";
                                                } elseif ($statut == 'LIVREE') {
                                                    $badgeClass = "badge badge-success-inverse";
                                                } elseif ($statut == 'EN_COURS') {
                                                    $badgeClass = "badge badge-warning-inverse";
                                                }
                ...
                <tr>
                    ...
                    <td>
                        <a class='mr-3' href='edit_livraison_index.php?id={$row['id']}'><i class='fe fe-edit'></i></a>
                    </td>
                </tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='2'>Pas des livraisons</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
